...
/**
 * @author C.Shawn
 * @date 2020/12/16 2:09 下午
 */
class Sword_32_2Test {
    private final Sword_32_2 test = new Sword_32_2();
    ...
    public void levelOrder(TreeNode root, ArrayList<List<Integer>> expected) {
